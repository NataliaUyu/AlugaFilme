...
<body class="backgroundTelaAlterarCliente">
		...
		<h:form>
			<center>
				...
				<h:panelGrid columns="2">
					...
					<h:inputText value="#{clienteBacking.nome}" maxlength="50"
				...
				<h:panelGrid columns="2">
					...
					<h:inputText value="#{clienteBacking.dataNascimento}"
						maxlength="50" size="34" onkeyup="masc_nascimento(this)"
						readonly="true" />
				</h:panelGrid>
				...
				<h:panelGrid>
					<h:panelGrid columns="2">
						<h:commandButton style="margin: 30px" value="Alterar"
