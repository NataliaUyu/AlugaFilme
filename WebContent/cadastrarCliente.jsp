...
<body class="backgroundTelaCadastroCliente">


	<f:view>
		<jsp:include page="/menu.jsp"></jsp:include>
		<h:form styleClass="cadastroCliente">
		<center>
			...
			<h:panelGrid columns="2">
				...
				<h:inputText value="#{clienteBacking.idade}" maxlength="3" size="50" onkeyup="masc_numero(this)"/>			
			</h:panelGrid><br>
		
			<h:panelGrid>
				<h:panelGrid columns="2">
					<h:commandButton style="margin-right: 20px" value="Salvar" action="#{clienteBacking.salvar}" styleClass="button2" />
					<h:commandButton value="Cancelar" action="#{clienteBacking.cancelar}"  styleClass="button2"/>
				</h:panelGrid>			
			</h:panelGrid>
			</center>
		</h:form>
